...
from .views.api import (
    ...
    CancelarAssinaturaAPIView,
    IngressosAPIView,
    IngressosCheckoutAPIView,
    IngressosCheckoutPreviewAPIView,
    EsqueciSenhaAPIView,
    LoginAPIView,
    LogoutAPIView,
...
urlpatterns = router.urls + [
    ...
    path('ingressos/', IngressosAPIView.as_view(), name='api-ingressos'),
    path('ingressos/preview/', IngressosCheckoutPreviewAPIView.as_view(), name='api-ingressos-preview'),
    path('ingressos/comprar/', IngressosCheckoutAPIView.as_view(), name='api-ingressos-comprar'),
    ...
    path('cancelar-assinatura/', CancelarAssinaturaAPIView.as_view(), name='api-cancelar-assinatura'),
