...
INSERT INTO `compra` VALUES (1,36,1,1,250),(2,36,2,1,250),(3,36,3,1,250),(4,38,1,1,300),(5,38,3,1,300),(6,39,3,1,280),(7,49,4,1,100),(8,47,5,1,350),(9,38,6,1,300),(10,36,6,1,250),(11,49,6,1,100),(12,41,6,1,250),(13,46,7,5,390);
...
INSERT INTO `pedido` VALUES (1,'2026-01-14 18:51:02','entregue',127,NULL),(2,'2026-01-14 18:59:54','entregue',127,NULL),(3,'2026-01-15 19:27:22','entregue',127,NULL),(4,'2026-01-15 22:37:12','entregue',127,NULL),(5,'2026-01-15 23:34:26','a caminho',127,NULL),(6,'2026-01-15 23:35:48','a caminho',127,NULL),(7,'2026-01-15 23:42:36','a caminho',127,NULL);
...
INSERT INTO `produtos` VALUES (36,'Camisa Branca Retrô',249.9,'Camisa branca oficial do AC Milan, ideal para torcedores que buscam estilo e conforto (Uniforme 2).',48,2,'img/produtos/camisas/camisa_branca_retro/camisa_branca(1).webp',NULL),(37,'Camisa Milan Retrô Clássica',199.9,'Reedição histórica de camisas clássicas do Milan. Design nostálgico para colecionadores.',20,2,'img/img_novas/milan authentic 125TH anniversary jersey.webp',NULL),(38,'Camisa Milan Home Listrada',299.9,'A tradicional camisa Rubro-Negra (Rossoneri). O manto sagrado para jogos em casa.',98,2,'img/camisa_home_figma.png',NULL),(39,'Camisa Milan Third amarela',279.9,'Uniforme alternativo na cor amarela com detalhes modernos. Elegância para uso casual ou esportivo.',34,2,'img/img_novas/camisa amraela milan frente.webp',NULL),(40,'Casaco branco',349.9,'Casaco oficial do time',15,2,'img/img_novas/TRACK SWEATSHIRT PUMA X AC MILAN X OFF-WHITE.webp',NULL),(41,'Camisa Verde goleiro',250,'Camisa do goleiro do time',28,2,'img/produtos/camisas/camisa_goleiro_verde/camisa_goleiro_verde (1).webp',NULL),(42,'Camisa manga longa preta',300,'Camisa chique de manga longa',9,2,'img/produtos/camisas/camisa_manga_longa/camisa_manga_longa_preta (1).webp',NULL),(43,'Camisa listrada retrô',260,'Camisa clássica antiga',4,2,'img/produtos/camisas/camisa_listrada_retro/camisa_listrada_retro (1).webp',NULL),(44,'Cachecol',99.9,'Cachecol personalizado para fugir do frio com o calor do seu time',31,1,'img/produtos/acessorios/objeto 1/cachecol_transparent (3).png',NULL),(45,'Boneco',139.99,'Boneco do seu time',45,1,'img/produtos/acessorios/objeto 2/boneco_transparent (3).png',NULL),(46,'Gorro',77.99,'Proteja-se do sol com o seu timão',53,1,'img/produtos/acessorios/objeto 3/touca_transparent.png',NULL),(47,'Mascote',350,'Divirta-se',26,1,'img/produtos/acessorios/boneco_milan/BEBRICKSML-A13_01_20148283-7119-4561-b84b-8e572aff7351.webp',NULL),(48,'Garrafa retro',299.9,'Geladinha',23,1,'img/garrafa_home_figma.png',NULL),(49,'Sandália do clube',99.99,'Conforto e paixão',17,3,'img/produtos/calcados/sandalia.png',NULL),(52,'Arquibancada lado B',100,'Drako X Palmeiras - 15/12/2025',60,10,NULL,NULL),(53,'Arquibancada lado A',60,'Drako X Palmeiras - 15/12/2025',150,10,NULL,NULL),(54,'Camarote Premium',175,'Drako x Palmeiras - 15/12/2025',10,10,NULL,NULL),(55,'Camarote',150,'Drako x Palmeiras - 15/12/2025',15,10,NULL,NULL),(56,'Caneca Drakos',45.9,'Caneco cheio de Paixão',32,1,'img/produtos/acessorios/objeto 5/caneca(3)transparente.png',NULL);
...
-- Dump completed on 2026-05-15  1:22:58
